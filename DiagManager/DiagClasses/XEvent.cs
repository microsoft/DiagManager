        ...
        public Xevent(string EventElement)
        {
            ...
            while (iterEvent.MoveNext())
            {
                ...
                foreach (Scenario evtTemp in XMgr.GlobalEventTemplateList)
                {
                    ...
                    //EventTemplate tempClone = ObjectCopier.Clone<EventTemplate>(evtTemp);
                    //tempClone.EventEnabled = tempEnabled;
                    if (tempEnabled)
                    {
                ...
                //this.General = Convert.ToBoolean(iterEvent.Current.GetAttribute("general", ""));
                //this.Detailed = Convert.ToBoolean(iterEvent.Current.GetAttribute("detail", ""));
                //this.Replay = Convert.ToBoolean(iterEvent.Current.GetAttribute("replay", ""));
