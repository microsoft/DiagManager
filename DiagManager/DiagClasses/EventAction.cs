...
{
    [Serializable()]
    public class EventAction : DiagItem, IComparable<EventAction>
    {
        public string Package { set; get; }

        public string FullName
        {
            get { return string.Format("{0}.{1}", Package, Name); }
        }
        ...
        public EventAction(string package, string name)
        {
            this.Package = package;
            this.Name = name;
        }
        public EventAction(string EventFieldElement)
        {
            ...
            XPathNodeIterator iterEventField = rootnav.Select("//action");
            ...
            while (iterEventField.MoveNext())
            {
                ...
                this.Package = Convert.ToString(eventNav.GetAttribute("package", ""));
                counter++;
            ...
            if (counter != 1)
            {
                throw new ArgumentException("The XML passed for Event action is not valid and should only contain one record");
            }
        }
    }
}
