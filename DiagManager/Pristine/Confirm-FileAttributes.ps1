...
# TODO: deal with ManualStart, ManualStop and pssdiag_xevent.sql
    ...
    $expectedFileAttributes = @(
        ...
        ,[PSCustomObject]@{Algorithm = "SHA512"; Hash = "06E53BFD76C9FFA085B156AD3A495F8BA73A1F2B287AC2E7ED9B4D85A5D422A86511B2CC8F92EB834295FB474452C6AB247D7EC622F35FEC65516129E940C3E6"; FileName = ".\SQL Server Perf Stats Snapshot.sql"; FileSize = 35486}
